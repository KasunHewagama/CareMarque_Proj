...
//	}
	...
	public String registerPatient(String patientId, String firstName, String lastName, String gender, String NIC, String DOB, String email,
...
//			String query = "INSERT INTO patient('patientId', 'firstName', 'lastName, gender, NIC, DOB, email, phone, bloodGroup, allergies, password, cPassword) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
			String query = "INSERT INTO patient('patientId', 'firstName', 'lastName', 'gender', 'NIC', 'DOB', 'email', 'phone', 'bloodGroup', 'allergies', 'password', 'cPassword') VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
